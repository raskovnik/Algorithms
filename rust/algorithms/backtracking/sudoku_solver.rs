...
fn is_in_row(board: &[[i8;9];9], row: &usize, number: &i8) -> bool{
    for col in 0..9 {
...
fn is_in_column(board: &[[i8;9];9], col: &usize, number: &i8) -> bool {
    for row in 0..9 {
        if board[row][*col] == *number {
            return true;
        }
...
fn is_in_box(board: &[[i8;9];9], row: &usize, col: &usize, number: &i8) -> bool {
    let l_col = *&col - (*&col % 3);
    let l_row = *&row - (*&row % 3);
...
fn is_valid_placement(board: &[[i8;9];9], row: &usize, col: &usize, number: &i8) -> bool {
...
fn main() {
    let mut board = [[7,0,2,0,5,0,6,0,0],
                    [0,0,0,0,0,3,0,0,0],
                    [1,0,0,0,0,9,5,0,0],
                    [8,0,0,0,0,0,0,9,0],
                    [0,4,3,0,0,0,7,5,0],
